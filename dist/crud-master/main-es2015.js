...
let AppComponent = class AppComponent {
    constructor(modalService, fb, commonService) {
...
class CommonValidator {
    ...
    static matchOtherValidator(otherControlName) {
        return (control) => {
            const otherControl = control.root.get(otherControlName);
            if (otherControl) {
                const subscription = otherControl
                    .valueChanges
                    .subscribe(() => {
...
let JwModalComponent = class JwModalComponent {
...
JwModalComponent.ctorParameters = () => [
    { type: _modal_service__WEBPACK_IMPORTED_MODULE_2__["ModalService"] },
